...
SOURCE="${DSH_TELEGRAM_SOURCE:-github:andrepontesmelo/dsh-telegram-channel}"
...
allowBuilds:
  ...
  'dsh-telegram-channel@git+https://github.com/andrepontesmelo/dsh-telegram-channel.git': true
EOF
  ...
  grep -q 'dsh-telegram-channel@git+https://github.com/andrepontesmelo/dsh-telegram-channel.git' "$ws" || need_repo=1
  ...
  [[ "$need_repo" -eq 1 ]] && insert+=$'  '\''dsh-telegram-channel@git+https://github.com/andrepontesmelo/dsh-telegram-channel.git'\'': true\n'
